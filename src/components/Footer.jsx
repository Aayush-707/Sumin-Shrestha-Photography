        ...
        <footer className="w-full bg-[#F2F2F2]">
            <div className='flex justify-between items-center lg:px-50 md:px-22 sm:px-12 py-8 px-4'>
                ...
                <button onClick={handleCopy} className="group border flex justify-center items-center gap-1 sm:w-[140px] w-[100px] p-2 whitespace-nowrap hover:bg-[#212121] cursor-pointer transition duration-300 ease-in-out">
                    ...
                    viewBox="0 0 24 24"
                    className="md:size-5 size-3 fill-current text-black group-hover:text-white"
                    >
                    ...
                    <span className="text-black text-xs md:text-[16px] group-hover:text-white">{copied ? "Copied!" : "Call now"}</span>
                </button>
            </div>
